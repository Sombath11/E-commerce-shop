      ...
      <?php include('navigation.php'); ?>
        ...
        <?php 
            ...
            if(isset($_POST['search_input'])){
                ...
                $search_pattern = strval("%".$search_input."%");

                $stmt2 = $conn->prepare("select * from products where product_category like ? or product_name like ? limit $offset, $total_products_per_page");
                $stmt2->bind_param("ss", $search_pattern, $search_pattern);  
                $stmt2->execute();
                ...
                <?php foreach($products as $product) { ?>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="edit">
                                <p><a href="<?php echo "edit_product_image.php?product_id=".$product['product_id']; ?>">Edit Image</a></p>
                            </td>
